                            ...
                            <tbody>
                                <tr>
                                    <td data-checkbox="true">
                                        <input class="form-control" type="text" name="email" value="<?php if (isset($_POST['email'])) {
                                                                                                        echo $_POST['email'];
                                                                                                    } else {
                                                                                                        echo $row['email'];
                                                                                                    } ?>" required="">
                                    ...
                                    <td data-checkbox="true">
                                        <input class="form-control" type="text" name="mat_khau" value="<?php if (isset($_POST['mat_khau'])) {
                                                                                                            echo $_POST['mat_khau'];
                                                                                                        } else {
                                                                                                            echo $row['mat_khau'];
                                                                                                        } ?>" required="">
                                    ...
                                    <td data-checkbox="true">
                                        <input name="quyen_truy_cap" type="number" min="1" max="2" class="form-control text-center" value="<?php if (isset($_POST['quyen_truy_cap'])) {
                                                                                                                                                echo $_POST['quyen_truy_cap'];
                                                                                                                                            } else {
                                                                                                                                                echo $row['quyen_truy_cap'];
                                                                                                                                            } ?>">
                                    </td>
                                </tr>
                            </tbody>
