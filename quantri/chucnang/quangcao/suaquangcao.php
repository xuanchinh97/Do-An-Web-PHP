                            ...
                            <tbody>
                                <tr>
                                    <td data-checkbox="true">
                                        <input class="form-control" type="text" name="id_thue" value="<?php if (isset($_POST['id_thue'])) {
                                                                                                            echo $_POST['id_thue'];
                                                                                                        } else {
                                                                                                            echo $row['id_thue'];
                                                                                                        } ?>" required="">
                                    ...
                                    <td data-checkbox="true">
                                        <input class="form-control" type="text" name="ten_anh" value="<?php if (isset($_POST['ten_anh'])) {
                                                                                                            echo $_POST['ten_anh'];
                                                                                                        } else {
                                                                                                            echo $row['ten_anh'];
                                                                                                        } ?>" required="">
