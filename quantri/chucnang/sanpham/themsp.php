                ...
                <form method="post" enctype="multipart/form-data" role="form">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bao_hanh" value="Bảo hành 12 tháng tại trung tâm bảo hành Chính hãng" required="">
                        </div>

                        <div class="form-group">
                            <label>Đi kèm</label>
                            <input type="text" class="form-control" name="phu_kien" value="Sách hướng dẫn, Cây lấy sim, Ốp lưng, Cáp sạc" required="">
                        </div>
                        <div class="form-group">
                            <label>Tình trạng</label>
                            <input type="text" class="form-control" name="tinh_trang" value="Máy mới, chính hãng đầy đủ phụ kiện từ nhà sản xuất" required="">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="khuyen_mai" value="Dán Màn hình 3 lớp chống xước chính hãng" required="">
                        </div>
                        <div class="form-group">
