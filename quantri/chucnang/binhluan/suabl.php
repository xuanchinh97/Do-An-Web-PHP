                        ...
                        <table data-toggle="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td data-checkbox="true">
                                        <input class="form-control" type="text" name="dien_thoai" value="<?php if (isset($_POST['dien_thoai'])) {
                                    ...
                                    <td data-checkbox="true">
                                        <textarea class="form-control" rows="3" name="binh_luan"><?php if (isset($_POST['binh_luan'])) {
