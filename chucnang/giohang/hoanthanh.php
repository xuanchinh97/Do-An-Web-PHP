<div class="ordered">
    ...
    <p align-items="center">Cám ơn Quý khách đã sử dụng Sản phẩm của Công ty chúng Tôi!</p>
</div>
<p id="return-home" align-items="right"><a href="index.php">Quay về trang chủ</a></p>
